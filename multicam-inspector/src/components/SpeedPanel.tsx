          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold text-gray-700">Mission Speed (Outbound)</span>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className={`text-4xl font-bold ${getSpeedColor((speeds.averageSpeedDuringWPOut || speeds.outboundSpeed || 0) * 3.6)}`}>
                  {((speeds.averageSpeedDuringWPOut || speeds.outboundSpeed || 0) * 3.6).toFixed(1)}
                  <span className="text-xl ml-1 text-gray-600">km/h</span>
                </p>
            ...
            {speeds.calculationMethod?.out && (
              <div className="mt-3 pt-3 border-t border-blue-100">
                <span className="text-[10px] text-gray-600">Calculation method: </span>
          ...
          {speeds.totalDistance && (
            <div className="bg-gray-50 rounded-lg p-3">
              <div className="flex items-center gap-1 mb-2">
                ...
                <span className="text-xs font-medium text-gray-700">Total Distance</span>
              </div>
          ...
          {flightDuration && (
            <div className="bg-gray-50 rounded-lg p-3">
              <div className="flex items-center gap-1 mb-2">
                ...
                <span className="text-xs font-medium text-gray-700">Flight Time</span>
              </div>
              <p className="text-xl font-bold text-gray-900">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-white border rounded-lg p-2">
            <div className="flex items-center gap-1 mb-1">
              ...
              <span className="text-[10px] font-medium text-gray-600">Outbound</span>
            </div>
            <p className={`text-lg font-bold ${getSpeedColor((speeds.averageSpeedDuringWPOut || speeds.outboundSpeed || 0) * 3.6)}`}>
              {((speeds.averageSpeedDuringWPOut || speeds.outboundSpeed || 0) * 3.6).toFixed(1)}
              <span className="text-xs text-gray-500 ml-0.5">km/h</span>
            </p>
          </div>
          ...
          <div className="bg-white border rounded-lg p-2">
            <div className="flex items-center gap-1 mb-1">
              ...
              <span className="text-[10px] font-medium text-gray-600">Return</span>
            </div>
            <p className={`text-lg font-bold ${getSpeedColor((speeds.averageSpeedDuringWPHome || 0) * 3.6)}`}>
          ...
          <div className="bg-white border rounded-lg p-2">
            <div className="flex items-center gap-1 mb-1">
              ...
              <span className="text-[10px] font-medium text-gray-600">Max</span>
            </div>
            <p className={`text-lg font-bold ${getSpeedColor((speeds.maxSpeed || 0) * 3.6)}`}>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-gray-50 rounded-lg p-2">
            <div className="flex items-center gap-1 mb-1">
              ...
              <span className="text-[10px] font-medium text-gray-600">Max Ascent</span>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-2">
            <div className="flex items-center gap-1 mb-1">
              ...
              <span className="text-[10px] font-medium text-gray-600">Max Descent</span>
            </div>
            <p className="text-lg font-bold text-gray-800">
