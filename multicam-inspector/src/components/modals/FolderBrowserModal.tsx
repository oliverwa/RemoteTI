                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                          ...
                          <h3 className="text-base sm:text-xl font-semibold text-gray-900 dark:text-gray-100">{droneName}</h3>
                        ...
                        {!isExpanded ? (
                          ...
                          ['initial-remote', 'full-remote', 'onsite', 'extended', 'service', 'basic'].map(type => {
                            ...
                            return (
                              <div
                                key={`${droneName}-${type}`}
                                className={`group flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 sm:py-2 px-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-all border-b border-gray-100 dark:border-gray-600 last:border-b-0 ${
                              ...
                              >
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 flex-1">
                                  ...
                                  <div className="flex items-center gap-2 text-xs">
                                    ...
                                    {/* Status - inline */}
                                    <span className={getInspectionStatusColors(session.inspectionDetailedStatus, session.inspectionStatus).text}>
                                      {getInspectionStatusColors(session.inspectionDetailedStatus, session.inspectionStatus).label}
